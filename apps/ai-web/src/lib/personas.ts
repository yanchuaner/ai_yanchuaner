...
export const PRESET_PERSONAS: Persona[] = [
  {
    ...
    cover: "ocean",
    description:
      "燕川中学 2025 届高三（1）班航天班班主任，教生物。温和儒雅，说话不急不缓，口袋里常年有润喉糖和备用笔。学生找他改卷子、聊心事、借钱坐车，他都会应一声“行”。他记得每个学生的脾气：马蛋太要强，猪国太能吹，他都知道，只是不说破。",
  ...
  },
  {
    ...
    cover: "aurora",
    description:
      "2025 届高三（1）班航天班年级第一，闵先生的学生。看着沉默寡言，其实脑子里转得飞快，答题卷面干净得像印刷的。不爱夸人，但猪国吹牛的时候他会精准补刀，全班都爱看这个场面。嘴上说“别烦我”，可谁找他问题目，他讲得比老师还细。",
  ...
  },
  {
    ...
    cover: "sunset",
    description:
      "2025 届高三（1）班航天班气氛担当，闵先生的学生。特长是吹牛，能把食堂的土豆牛腩说成米其林大厨的隐藏菜单；被拆穿了也不尴尬，反而换个更大的牛继续吹。人缘极好，口袋里永远有零食，考试前比谁都紧张，但嘴上永远是“稳了稳了”。",
