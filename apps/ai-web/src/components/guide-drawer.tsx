...
const steps = [
  ...
  },
  {
    icon: ImagePlus,
    title: "语音与图片",
    text: "工具抽屉的「语音」「媒体」填你自己的服务地址与 API Key，就能语音输入、朗读、看图、画图。",
  },
];
...
const modules = [
  ...
  },
  {
    ...
    items: [
      ...
      "可以选一个世界观：燕川中学、星际航线，或自己在工具抽屉里新建。",
  ...
  },
  {
    title: "语音与媒体",
    items: [
      "语音：在工具抽屉「语音」里配置 ASR/TTS 服务，输入框有录音和朗读按钮，音色可调。",
      "图片：在「媒体」里配置视觉与画图模型，可以上传图片让角色看，也可以输入提示词生成图片。",
