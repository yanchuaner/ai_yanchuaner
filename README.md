...
截至 2026 年 8 月 13 日，自主 `apps/ai-web` 已上线 `ai.yanchuaner.cn`：主站 OIDC、加密 HttpOnly 会话、YanCore 主体交换、DeepSeek 真实对话、额度流水与审计均已实跑。工作台已支持普通助手与角色扮演两种模式，角色卡可自定场景、世界观和剧情，自定义角色保存到按用户隔离的个人角色库。Open WebUI 与 LiteLLM 仅保留内网过渡，不再作为公网产品入口；失败退款、request ID 对账与跨渠道故障切换仍待完成。
